...
class Quitenicebooking_Accommodation_Post {
		...
		register_post_type('accommodation',
			array(
				'labels'		=> array(
					...
					'add_new'		=> _x('Add Lodging', 'accommodation', 'quitenicebooking'),
					'add_new_item'	=> __('Add New Lodging', 'quitenicebooking'),
				),
				'public'		=> TRUE,
				'menu_icon'		=> 'dashicons-admin-post',
				'menu_position'	=> 5, // below Posts
				'rewrite'		=> array(
					'slug'			=> __('hebergement', 'quitenicebooking'),
				),
	...
	public function add_meta_boxes() {
		...
		add_meta_box(
			...
			__('Lodging Details', 'quitenicebooking'), // title
