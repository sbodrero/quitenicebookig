		...
		<table class="form-table">
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="hidden" name="quitenicebooking[enable_smtp]" value="0"><input type="checkbox" name="quitenicebooking[enable_smtp]" id="quitenicebooking[enable_smtp]" value="1" <?php checked( isset( $this->settings['enable_smtp'] ) ? $this->settings['enable_smtp'] : 0, 1 ); ?>/>
				...
				<tr>
					...
					<td>
						<input type="hidden" name="quitenicebooking[smtp_auth]" value="0"><input type="checkbox" name="quitenicebooking[smtp_auth]" id="quitenicebooking[smtp_auth]" value="1" <?php checked( isset( $this->settings['smtp_auth'] ) ? $this->settings['smtp_auth'] : 0, 1 ); ?>/>
