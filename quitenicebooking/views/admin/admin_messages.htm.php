		...
		<table class="form-table">
			<tbody>
				...
				<tr>
					...
					<td><textarea class="large-text" name="quitenicebooking[booking_success_message]" id="quitenicebooking[booking_success_message]" rows="5"><?php echo $this->settings['booking_success_message']; ?></textarea></td>
				</tr>
				<tr>
					<th scope="row"><label for="quitenicebooking[payment_success_message]"><?php _e('Payment success message', 'quitenicebooking'); ?></label></th>
					<td><textarea class="large-text" name="quitenicebooking[payment_success_message]" id="quitenicebooking[payment_success_message]" rows="5"><?php echo $this->settings['payment_success_message']; ?></textarea></td>
				</tr>
				<tr>
					<th scope="row"><label for="quitenicebooking[payment_fail_message]"><?php _e('Payment fail message', 'quitenicebooking'); ?></label></th>
					<td><textarea class="large-text" name="quitenicebooking[payment_fail_message]" id="quitenicebooking[payment_fail_message]" rows="5"><?php echo $this->settings['payment_fail_message']; ?></textarea></td>
				</tr>
				<tr>
